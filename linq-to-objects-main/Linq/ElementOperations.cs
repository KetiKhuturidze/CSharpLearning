...
namespace Linq
{
    ...
    public static class ElementOperations
    {
        ...
        public static Product FirstElement()
        {
            ...
            return products.Single(x => x.ProductId == 11);
        }
        ...
        public static Product MaybeFirstMatchingElement()
        {
            ...
            return products.SingleOrDefault(x => x.ProductId == 789, null);
        }
        ...
        public static int ElementAtPosition()
        {
            ...
            var vals = from i in numbers
                  where i > 5
                  select i;

            return vals.ElementAt(1);
        }
        ...
        public static string LastMatchingElement()
        {
            ...
            return strings.Last(x => x.Contains('o'));
        }
        ...
        public static string SingleMoreThanOneMatchingElement()
        {
            ...
            return strings.Single(x => x.Contains('o', StringComparison.InvariantCulture));
        }
        ...
        {
            string[] strings = { "five", "six", "seven", "eight", "nine" };

            return strings.SingleOrDefault(x => x.Contains('o'), null);
        }
    }
}

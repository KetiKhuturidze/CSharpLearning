...
namespace Linq
{
    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<string> DistinctPropertyValues()
        {
            ...
            return products.Select(product => product.Category).Distinct();
        }
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            return products.Select(x => x.ProductName[0]).Union(customers.Select(x => x.CompanyName[0])).Distinct();
        }
        ...
        public static IEnumerable<char> IntersectQueryResults()
        {
            ...
            return products.Select(x => x.ProductName[0]).Intersect(customers.Select(x => x.CompanyName[0]));
        }

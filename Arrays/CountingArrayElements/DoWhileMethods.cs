...
namespace CountingArrayElements
{
    ...
    {
        /// <summary>
        /// Searches an array of booleans for false elements,
        /// and returns the number of occurrences of false values.
        /// </summary>
        ...
        /// <summary>
        /// Searches an array of decimal floating-point numbers for zero elements,
        /// and returns the number of occurrences of zero values.
        /// </summary>
        /// <param name="arrayToSearch">An <see cref="Array"/> to search.</param>
        ...
        /// <summary>
        /// Searches an array of double-precision floating-point numbers for elements that can be rounded to even,
        /// and returns the number of occurrences of numbers that can be rounded to even.
        /// </summary>
        /// <param name="arrayToSearch">An <see cref="Array"/> to search.</param>
        ...
        public static int GetRoundedToEvenCount(double[]? arrayToSearch)
        {
            ...
            do
            {
                int wholePart = (int)arrayToSearch[i];

                if (arrayToSearch[i] - wholePart >= 0.5)
                {
                    if ((wholePart + 1) % 2 == 0)
                    {
                        count++;

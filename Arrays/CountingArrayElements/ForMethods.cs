...
namespace CountingArrayElements
{
    ...
    {
        /// <summary>
        /// Searches an array of integers for negative elements,
        /// and returns the number of occurrences of negative integers.
        /// </summary>
        ...
        /// <summary>
        /// Searches an array of single-precision floating-point numbers for even elements,
        /// and returns the number of occurrences of even numbers.
        /// </summary>
        /// <param name="arrayToSearch">An <see cref="Array"/> to search.</param>
        ...
        /// <summary>
        /// Searches an array of bytes for elements with enabled bits in high nibble,
        /// and returns the number of occurrences of bytes with enabled bits in high nibble.
        /// </summary>
        /// <param name="arrayToSearch">An <see cref="Array"/> to search.</param>
        ...
        /// <summary>
        /// Searches an array of integers for negative elements, and returns the number of occurrences of
        /// negative integers.
        /// </summary>
        /// <param name="arrayToSearch">An <see cref="Array"/> to search.</param>
        /// <returns>The number of occurrences of negative integers.</returns>
        public static int GetNegativeIntegerCountRecursive(int[]? arrayToSearch)
        {
            ...
            int currentIncrement = arrayToSearch[0] < 0 ? 1 : 0;
            return GetNegativeIntegerCountRecursive(arrayToSearch[1..]) + currentIncrement;
        }
        ...
        public static int GetEvenNumberCountRecursive(float[]? arrayToSearch)
        {
            ...
            int currentIncrement = (arrayToSearch[0] % 2.0f == 0f) ? 1 : 0;
